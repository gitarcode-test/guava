...
class StatsTesting {
  ...
  static DoubleStream megaPrimitiveDoubleStream() {
    return DoubleStream.iterate(0.0, x -> x + 1.0).limit(100).parallel();
  }
  ...
  static DoubleStream megaPrimitiveDoubleStreamPart1() {
    return DoubleStream.iterate(0.0, x -> x + 2.0).limit(100 / 2).parallel();
  }
  ...
  static DoubleStream megaPrimitiveDoubleStreamPart2() {
    return DoubleStream.iterate(999_999.0, x -> x - 2.0).limit(100 / 2).parallel();
  }

  static final long MEGA_STREAM_COUNT = 100;
  static final double MEGA_STREAM_MIN = 0.0;
  static final double MEGA_STREAM_MAX = 100 - 1;
